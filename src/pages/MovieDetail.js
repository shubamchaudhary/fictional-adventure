...
export const MovieDetail = () => {
  ...
  useEffect(() => {
    async function fetchMovie(){
      const response = await fetch(`https://api.themoviedb.org/3/movie/${params.id}?api_key=d3fe83878d8f94b1d6e52da4d1392036`);
    ...
    <main className="pt-40 pb-40">
      <section className="flex justify-around flex-wrap py-5">
        <div className="max-w-md">
          <img className="rounded shadow-lg shadow-black hover:shadow-black hover:shadow-lg" src={image} alt={movie.title} />
        </div>
