...
export const Header = () => {
  ...
  return (
    <nav className="opacity-80">      
      <nav className= " fixed right-[5%] w-[74%] top-0  bg-white rounded-full mr-[10%] ml-[10%]  shadow-md  px-2 sm:px-4 py-2 dark:bg-gray-800 dark:border-b-1 shadow-gray-900">
        <div className="flex mt-2 mb-2   flex-wrap justify-between items-center mx-auto">
            <Link to="/" className="flex items-center ml-[5%]">
              <h1 className="text-5xl dark:text-white font- cursive">Movies</h1>
          </Link>
